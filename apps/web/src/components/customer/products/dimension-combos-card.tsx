...
const COMPONENT_DIMENSION_LABELS: Record<string, [string, string, string]> = {
...
function getDimensionLabels(componentType: string): [string, string, string] {
								...
								<TableBody>
									{combos.map((combo) => (
										<TableRow key={combo.id}>
											...
											<TableCell>{formatPrice(combo.priceAdjustment)}</TableCell>
											<TableCell>
