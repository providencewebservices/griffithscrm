		...
		<BrowserRouter>
			...
			<Routes>
				...
				>
					...
					<Route
						path="suppliers/:supplierId/collections/:collectionId"
						element={<SupplierCollectionDetailPage />}
					/>
					<Route
						path="suppliers/:supplierId/collections/:collectionId/products/:productId"
